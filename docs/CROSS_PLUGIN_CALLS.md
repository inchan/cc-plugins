...
1. [네임스페이스 형식](#네임스페이스-형식)
2. [Hook 자동 제안](#hook-자동-제안)
3. [플러그인 간 독립성 원칙](#플러그인-간-독립성-원칙)
4. [실제 사용 패턴](#실제-사용-패턴)
5. [작업 완료 후 권장사항](#작업-완료-후-권장사항)
6. [완료 체크리스트](#완료-체크리스트)
7. [구현 시 고려사항](#구현-시-고려사항)
8. [Hook 집계 메커니즘](#hook-집계-메커니즘)
9. [마이그레이션 가이드 (v1.x → v2.0.0)](#마이그레이션-가이드-v1x--v200)
